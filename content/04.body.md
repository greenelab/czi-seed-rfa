...
based on the "Applied Bioinformatics" one-week short course that has been run
annually at Mount Desert Island Biological Lab over the last **X TOM FILL IN**
years (PI Hampton). The existing course covers R, fundamentals of gene
expression analysis, statistical interpretation, and provides an introduction to
machine learning (PI Greene). Attendees include students and postdocs, faculty
from research intensive universities and faculty from primarily undergraduate
institutions. Attendees give the course high marks and report that they will use
what they learned at the short course in their research and teaching.
...
course materials on GitHub to allow others to replicate the course. The expanded
topics will include:
