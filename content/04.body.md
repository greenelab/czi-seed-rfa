...
hypothesis__** is that these approaches will also enable search and exploration at the tissue
...
aims: 1) fast and accurate search for cell, sample, and pathway signatures; 2) statistics
to assess, interpret, and annotate cell types using low-dimensional spaces; and 3)
...
method scCoGAPS [@doi:10.1101/378950,@doi:10.1101/395004] (PI Fertig) has
demonstrated its suitability for this domain. This method robustly infers a
...
cell state [@doi:10.1101/378950]. Notably for the work proposed in this seed
...
[@doi:10.1371/journal.pone.0078127]. As increasing spatial data becomes
...
with such methods [@doi:10.1101/385534] (PI Greene). However, because so many
...
with new methods appearing each month), we don't propose to do specific development work in
...
[@doi:10.1016/j.tig.2018.07.003]. The latent space team from the HCA
...
classes of methods, and is establishing a first draft catalog of annotated latent
spaces for the HCA. In Aim 3 we propose to, where required, write wrappers
