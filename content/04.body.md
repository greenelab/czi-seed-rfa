...
complex high-dimensional data. HCA data, and low-dimensional representation
methods that work with them, will be valuable to many biomedical fields, but
their use will require experience with this new toolkit. A scalable education
effort that reaches students at and beyond undergraduate level will be needed to
prepare students and maximize impact. *We propose deliver short-course training
on the HCA, single cell profiling, machine learning methods, low-dimensional
representations, and tools developed by our group in response to this RFA.*
...
Comparison of Bulk and Single-cell Biology
